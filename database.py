...
class DatabaseManager:
    ...
    async def init_pool(self) -> bool:
        ...
        for attempt in range(1, 4):
            ...
            try:
                logger.info(
                    "Initializing database connection, attempt %s...",
                    attempt,
                )
    ...
    async def update_game_called_numbers(
        self,
        game_id,
        numbers,
    ):
    ...
    async def create_withdrawal_request(
        ...
        reference = (
            f"withdraw:{telegram_id}:{secrets_token()}"
        )
